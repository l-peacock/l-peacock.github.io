...
function Popup(props){
    ...
    return(
        <div className="Popup" onClick={()=> {if(selected === "0")setSelected("1")}} expanded={selected} >
            ...
            <a href="https://iconscout.com/icons/person" target="_blank">Person Icon</a> by <a href="https://iconscout.com/contributors/google-inc" target="_blank">Google Inc.</a><br />
            <br />
